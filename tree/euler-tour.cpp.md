...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"tree/euler-tour.cpp\"\n\n#line 2 \"template.cpp\"\n\n#ifndef\
    ...
    \ Graph = vector<vector<Edge>>;\n#line 5 \"tree/euler-tour.cpp\"\n\nvoid euler_tour(const\
    \ VVI& graph, VI& tour, VI& left, VI& right,\n                int v = 0, int par\
    \ = -1) {\n  left[v] = tour.size();\n  tour.push_back(v);\n  for (auto next :\
  ...
  code: "#pragma once\n\n#include \"template.cpp\"\n#include \"graph/graph.cpp\"\n\
    ...
    \       int v = 0, int par = -1) {\n  left[v] = tour.size();\n  tour.push_back(v);\n\
    \  for (auto next : graph[v])\n    if (next != par) euler_tour(graph, tour, left,\
    \ right, next, v);\n  tour.push_back(v);\n  right[v] = tour.size();\n}\n"
  dependsOn:
  - template.cpp
  - graph/graph.cpp
  ...
  verifiedWith: []
documentation_of: tree/euler-tour.cpp
layout: document
redirect_from:
- /library/tree/euler-tour.cpp
- /library/tree/euler-tour.cpp.html
