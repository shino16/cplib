...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"data-structure/hash-table.cpp\"\n\n#line 2 \"template.cpp\"\
    ...
    \ ull RANDOM = uniform_int_distribution<ull>(0)(rd);\n  template <typename T>\n\
    \  ull operator()(T x) const {\n    return x ^ RANDOM;\n  }\n  template <typename\
    \ T, typename U>\n  ull operator()(pair<T, U> x) const {\n    return (*this)(x.first)\
    \ * 31 + (*this)(x.second);\n  }\n};\n\ntemplate <typename K, typename V>\nusing\
    \ hash_table = gp_hash_table<K, V, chash>;\n"
  ...
  requiredBy: []
  timestamp: '2020-05-27 03:08:41+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: data-structure/hash-table.cpp
layout: document
redirect_from:
- /library/data-structure/hash-table.cpp
- /library/data-structure/hash-table.cpp.html
